...
Create at least one data member and one member function in each class. 
That is n1 and putAlpha() in Alpha class, n2 and putBeta() in Beta class, n3 and putGamma() in Gamma class. 
...
class Gamma:public Alpha,public Beta{
    ...
    Gamma(int x,int y,int z):Alpha(x),Beta(y){
        cout<<"Gamma got constructed"<<endl;
        n3=z;
    }
    void getGamma(){
        cout<<"n3 : "<<n3<<endl;
